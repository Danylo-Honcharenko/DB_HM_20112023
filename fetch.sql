...
SELECT * FROM Lesson AS L JOIN Homework AS H ON H.id = L.homework_id;
SELECT * FROM Lesson AS L JOIN Homework AS H ON H.id = L.homework_id ORDER BY L.updatedAt DESC;
